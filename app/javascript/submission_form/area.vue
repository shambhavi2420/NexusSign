  ...
  computed: {
    ...
    fieldIcons () {
      return {
        ...
        // Custom candidate fields
        signerfirstname: IconTextSize,
        signerlastname: IconTextSize,
        signaturedate: IconCalendarEvent,
        signerfullname: IconTextSize,
        companyname: IconTextSize,
        currentdate: IconCalendarEvent,
        jobid: IconTextSize,
        datewithmonthname: IconCalendarEvent,
        dateofmonth: IconSquareNumber1,
        month: IconTextSize,
        year: IconSquareNumber1,
        signerprimaryphone: IconPhoneCheck,
        candidatepermanentaddress1: IconTextSize,
        candidatepermanentcity: IconTextSize,
        candidatepermanentstate: IconTextSize,
        candidatepermanentzip: IconTextSize,
        recruiter: IconTextSize,
        recruiterphone: IconPhoneCheck,
        recruiteremail: IconTextSize,
        candidatessn: IconTextSize,
        candidateavailablefrom: IconCalendarEvent,
        startdate: IconCalendarEvent,
        enddate: IconCalendarEvent,
        clientname: IconTextSize,
        recruitertitle: IconTextSize,
        signeremail: IconTextSize,
        candidateprimaryprofession: IconTextSize,
        candidateprimaryspecialty: IconTextSize,
        additionalinformationforexhibitandrider: IconTextSize,
        salesrepresentative: IconTextSize,
        workauthorization: IconTextSize
      }
    },
    image () {
