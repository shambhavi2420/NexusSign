const en = {
  ...
  mask_full: 'Mask entire value',
  mask_except_last_4: 'Mask except last 4 digits',
  page: 'Page',
...
const es = {
  ...
  mask: 'Enmascarar',
  no_masking: 'Sin enmascarar',
  mask_full: 'Enmascarar todo el valor',
  mask_except_last_4: 'Enmascarar excepto los últimos 4 dígitos',
  page: 'Página',
...
const it = {
  ...
  mask: 'Maschera',
  no_masking: 'Nessuna maschera',
  mask_full: "Maschera l'intero valore",
  mask_except_last_4: 'Maschera tranne le ultime 4 cifre',
  page: 'Pagina',
...
const pt = {
  ...
  mask: 'Mascarar',
  no_masking: 'Sem máscara',
  mask_full: 'Mascarar valor inteiro',
  mask_except_last_4: 'Mascarar exceto os últimos 4 dígitos',
  page: 'Página',
...
const fr = {
  ...
  mask: 'Masquer',
  no_masking: 'Aucun masquage',
  mask_full: 'Masquer toute la valeur',
  mask_except_last_4: 'Masquer sauf les 4 derniers chiffres',
  page: 'Page',
...
const de = {
  ...
  read_only: 'Nur lesen',
  mask: 'Maskieren',
  no_masking: 'Keine Maskierung',
  mask_full: 'Gesamten Wert maskieren',
  mask_except_last_4: 'Bis auf die letzten 4 Ziffern maskieren',
  page: 'Seite',
...
const nl = {
  ...
  mask: 'Maskeren',
  no_masking: 'Geen maskering',
  mask_full: 'Volledige waarde maskeren',
  mask_except_last_4: 'Maskeren behalve laatste 4 cijfers',
  page: 'Pagina',
