  ...
  computed: {
    fieldNames () {
      return {
        ...
        // Custom candidate fields - from Table 1
    ...
    fieldIcons () {
      return {
        ...
        currentdate: IconTextSize,
        jobid: IconTextSize,
        datewithmonthname: IconTextSize,
        dateofmonth: IconTextSize,
        month: IconTextSize,
        year: IconTextSize,
        candidateprimaryphone: IconTextSize,
        ...
        recruiterphone: IconTextSize,
        recruiteremail: IconTextSize,
        candidatessn: IconTextSize,
        startdate: IconTextSize,
        enddate: IconTextSize,
